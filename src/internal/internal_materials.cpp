...
void OpaqueMaterial::cleanUniformBuffers() {

	Material::cleanUniformBuffers();
...
void OpaqueMaterial::cleanMaterialResources(){

	Material::cleanMaterialResources();
...
void OpaqueMaterial::deleteMaterialResources(){

	Material::deleteMaterialResources();
...
void TranslucentMaterial::cleanUniformBuffers() {
...
void TranslucentMaterial::cleanMaterialResources(){
...
void TranslucentMaterial::deleteMaterialResources(){
